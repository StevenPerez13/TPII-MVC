...
//		r._y = matrix[1][0] * x + matrix[1][1] * y;
	...
	public static Vector2D get_random_vector_range(double min_y, double max_y, double min_x, double max_x) {
		assert (max_x >= min_x);
		assert (max_y >= min_y);
		double x = min_x + Utils._rand.nextDouble(max_x - min_x);
		double y = min_y + Utils._rand.nextDouble(max_y - min_y);
